...
function createNativeDevServerMiddleware(projectRoot, {
  ...
  const nativeMiddleware = (0, _devServer().createDevServerMiddleware)({
...
async function startAsync(projectRoot, options = {}) {
  ...
  const compiler = (0, _webpack().default)(config); // Create the middleware required for interacting with a native runtime (Expo Go, or a development build).
